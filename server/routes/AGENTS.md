...
成员清单
conversationRoutes.ts: express Router 会话端点，用 Zod 验证 conversation/participant/message/run payload，提供 direct/group/stop/get run 查询并委派 conversationService/conversationRunService
