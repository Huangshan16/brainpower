...
routes/conversationRoutes.ts: 会话路由，提供 create/list conversation、participant、message 与 direct/group/stop run 入口
...
test/conversationRunService.test.ts: 会话运行服务测试，验证 direct/group run、stop 与消息保留语义
